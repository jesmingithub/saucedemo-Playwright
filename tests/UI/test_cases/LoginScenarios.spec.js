...
test.describe('Positive Login Scenarios', () => {
    ...
    test('TC_01 : verify successful login to inventory page : @smoke',async ({page,loginPage})=>{
...
test.describe('Negative Login Scenarios', () => {
    ...
    */
    test('TC_03 : verify login with invalid credentials',async ({loginPage})=>{
    ...
    */
    test('TC_04 : verify login with empty credeentials',async ({loginPage})=>{
